      ...
      v-container
        v-layout
          v-flex(offset-xl3 xl6 offset-lg2 lg8 offset-md1 md10 sm12 xs12)
            ...
            v-bind:wallet="wallet" v-bind:walletPassword="walletPassword" v-bind:faucetUrl="faucetUrl" v-on:logoutWallet="logoutWallet" navTargetId="wallet")
...
<script>
  ...
  export default {
    components: {
      Header, Footer, Jumbo,
      Login, WalletInfo,
      Transfer, Namespace, SubNamespace, MosaicDefinition
    },
    asyncData (context) {
      return {
        nav: [
        ...
        endpoints: [
          ...
          { url: "http://120.79.181.170:3000", label: "120.79.181.170:3000" },
        ],
