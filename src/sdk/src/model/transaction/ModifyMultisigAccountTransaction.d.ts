...
export declare class ModifyMultisigAccountTransaction extends Transaction {
     ...
     */
    static create(deadline: Deadline, minApprovalDelta: number, minRemovalDelta: number, modifications: MultisigCosignatoryModification[], networkType: NetworkType): ModifyMultisigAccountTransaction;
    /**
     * @param networkType
     * @param version
     * @param deadline
